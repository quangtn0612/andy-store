...
export class DataProvider extends Component {
   ...
   render(){
      const {passportCovers, charms, currentItemOfPassport, currentItemOfWallet, cartItems, passportActiveId, walletActiveId, charmActiveId, wallets, wallet, PassportCover, Charm} = this.state;
      const {onKeyUp,chooseCharm,choosePassportCover,updateCart, passportOnClickedItem, charmOnClickedItem, deleteItem, walletOnClickedItem, onPassportTab, onWalletTab, chooseWallet} = this;
      
      return <DataContext.Provider value ={{
         cartItems,passportCovers,charms, currentItemOfPassport, currentItemOfWallet, passportActiveId, charmActiveId, wallets, walletActiveId, wallet, PassportCover, Charm,
         updateCart,onKeyUp,chooseCharm,choosePassportCover, passportOnClickedItem, walletOnClickedItem,charmOnClickedItem, deleteItem, onPassportTab, onWalletTab, chooseWallet,
      }}>
         {this.props.children}
